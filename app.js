...
var bucket = cluster.openBucket(process.env.COUCHBASE_BUCKET_NAME, process.env.COUCHBASE_BUCKET_PASSWORD);
...
app.get("/aditi", (request, response) => {
        response.send("Hello, this is Aditi's test code!");
